""" generate a tk-compatible geometry string from width and height"""


def generate_tk_geometry(root, width, height):
    """ generate a tk-compatible geometry string from width and height"""
...
if __name__ == '__main__':
    ...
    test_root = Tk()
    test_geometry = generate_tk_geometry(test_root, 1280, 720)
