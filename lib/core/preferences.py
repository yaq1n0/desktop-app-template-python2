""" preferences.py : this is where to store root variables for the app as well as manipulates the JSON files used to
...
user_preferences = loadJSON("resources/app_user_preferences.json")
default_preferences = loadJSON("resources/app_default_preferences.json")
